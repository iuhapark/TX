...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      <div className="fixed bottom-0 h-[22vh] z-50 rounded-t-2xl transition-all duration-300 p-3 w-full bg-white dark:bg-black" style={{ position: "fixed", bottom: "0", left: "0", right: "0" }}>
        <div className="mx-auto max-w-[100vh] flex items-center justify-between gap-4">
          <h4>{message ? message : ""}</h4>
          <form className="flex w-full items-center mt-1 shadow-none gap-5" onSubmit={handleSubmit(onSubmit)}>
            <input
              type="text"
